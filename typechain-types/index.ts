...
export type { DebateContract } from "./contracts/DebateContract";
export { DebateContract__factory } from "./factories/contracts/DebateContract__factory";
export type { DebateContractV2 } from "./contracts/DebateContractV2";
export { DebateContractV2__factory } from "./factories/contracts/DebateContractV2__factory";
export type { DebateToken } from "./contracts/DebateToken";
export { DebateToken__factory } from "./factories/contracts/DebateToken__factory";
